...
summary: <!-- теги для работы поиска -->
  - флексбокс
  - flexbox
  - flex-box
  - флекс-контейнер
  ...
  - align-content
cover:
  desktop: 'desktop.png' <!-- адрес картинки для десктопной обложки -->
  mobile: 'mobile.png' <!-- адрес картинки для мобильной обложки -->
...
Используйте нужные поля там, где это необходимо. Если вы не хотите заполнять какое-либо поле, не оставляйте его пустым, а просто удалите его (#545).

#### Обложки

В #534 в Доке появилась возможность добавлять к статьям обложки. Выглядят они вот так:

![Пример обложки](./src/assets/images/docs/contributing/contributing.png)

Используйте обложки там, где это необходимо.
